...
const Page3 = () => {
  ...
  <div className=' mb-1 md:mb-0 mr-3 ' data-aos="flip-up"><img src='/images/P3Logo.png' alt='' /></div>
  ...
  <div className=' mt-1 md:mt-0 ml-3' data-aos="flip-up"><img src='/images/P3Logo2.png' alt='' /></div>
</div>
